<?php
/**
 * Contact Information Component Template
 *
 * @package tasheel
 */
...
<section class="pt_80 pb_80 contact_information_section">
    <div class="wrap">

        <div class="contact_information_content_block">
            <div class="contact_information_content_item" data-aos="fade-up" data-aos-duration="800"
                ...
                <p>
                    Have questions or need assistance? Our team is ready to help. Fill out the form below, and we'll get
                ...
                <div class="contact_address_block">
                    ...
                    <div class="address_block_item">
                        <div class="contact_address_icon">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/mark.svg"
                                alt="Location">
                        </div>
                    ...
                    <div class="address_block_item">
                        ...
                        <p>
                            <a href="tel:+97143333333">+971 4 333 3333</a>
                        </p>
                    </div>
                ...
                <a href="#" class="whatsapp_icon">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/whatsap-icn.svg"
                        alt="Map Marker">
                </a>
            </div>
            <div class="contact_form_block" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200"
                data-aos-once="true">
