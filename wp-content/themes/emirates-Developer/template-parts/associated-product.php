...
<section class="pt_80 pb_80 associated_product_section  bg_black bg_shadow">
    ...
    <div class="global_brands_content_title pb_30">
				...
				<a href="" class="btn_style me-1 buttion_blue"> <span class="buttion_blue_icn"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/but-icn.svg"></span> Download Catalogue</a>
			</div>
