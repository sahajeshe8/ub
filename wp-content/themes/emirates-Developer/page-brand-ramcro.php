...
market needs.',
            ...
            array(
                ...
                'description' => 'These cables are designed to connect electrical instrument circuits and provide communication services in and around process plant (e.g. petrochemical industry etc.). Inside a complete gamma suitable for few applications and critic installations.BS 5308 cables are designed to carry communication and control signals in a variety of installation types including those found in the petrochemical industry. The signals can be of analogue, data or voice type and from a variety of transducers such as pressure, proximity or microphone.',
            ),
        ),
    );
